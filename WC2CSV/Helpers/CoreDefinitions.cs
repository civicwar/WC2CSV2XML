        ...
        public class AmmoDef
        {
            ...
            public struct TrajectoryDef
            {
                ...
                public struct ApproachDef
                {
                    ...
                    public bool AdjustSource { get; internal set; }
                    public bool AdjustDestination { get; internal set; }
                    public bool LeadAndRotateSource { get; internal set; }
                    public bool LeadAndRotateDestination { get; internal set; }
                    public RelativeTo Destination { get; internal set; }
                    public RelativeTo Source { get; internal set; }
                }
