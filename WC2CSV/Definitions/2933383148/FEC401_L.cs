...
namespace WyN.WeaponCore
{
    partial class Parts
    {
        WeaponDefinition OPC_FEC401_L => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = CreateSimilarMountPoints(
                    new MountPointDef
                    {
						...
						*/
                        MuzzlePartId = "FEC401_Gun",
                        AzimuthPartId = "FEC401_Gun", // this is fucking tower dummy, NOT base
                        ElevationPartId = "FEC401_Gun_Moving",
            ...
            Targeting = new TargetingDef
            {
                ...
                MaxTargetDistance = 7500.0f, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
            ...
            {
                PartName = "FEC401 L Luin Celtchar", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    HeatSinkRate = 75000, // Amount of heat lost per second.
