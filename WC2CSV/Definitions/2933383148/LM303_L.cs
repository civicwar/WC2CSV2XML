...
namespace WyN.WeaponCore
{
    partial class Parts
    {
        WeaponDefinition OPC_LM303_L => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "LM303_L", // Block Subtypeid. Your Cubeblocks contain this information
						SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
						MuzzlePartId = "LM303_L_Gun", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                ...
                Muzzles = new[] { // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
					"muzzle_missile_1","muzzle_missile_2","muzzle_missile_3",
                },
            ...
            Targeting = new TargetingDef
            {
                ...
                MaxTargetDistance = 20000.0f, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
                MinTargetDistance = 800.0f, // Minimum distance at which targets will be automatically shot at.
            ...
            {
                PartName = "LM303 Jericho-HL3", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                                                //PartName = OPC_Localization.GetText("OPC_LM320L_PartName_WC_LID"),
                DeviateShotAngle = 5.0f, // Projectile inaccuracy in degrees.
                AimingTolerance = 30.0, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 4f, // Inventory capacity in kL.
            ...
            Ammos = new[]
            {
                MSL_CRUS_308, //MSL_EMPW_309, MSL_DISB_310, Must list all primary, shrapnel, and pattern ammos.
			},
