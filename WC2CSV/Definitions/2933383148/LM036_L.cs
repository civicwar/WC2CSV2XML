...
namespace WyN.WeaponCore
{
    partial class Parts
    {
        WeaponDefinition OPC_LM036_L => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "LM036_L", // Block Subtypeid. Your Cubeblocks contain this information
						SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
						MuzzlePartId = "LM036_L_Gun", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
						AzimuthPartId = "None", // Your Rotating Subpart, the bit that moves sideways.
						ElevationPartId = "None",// Your Elevating Subpart, that bit that moves up.
						DurabilityMod = 0.25f, // GeneralDamageMultiplier, 0.25f = 25% damage taken.
						IconName = "Inventory\\MSL_HEAT_011x12_Magazine.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
					},
                },
                Muzzles = new[] { // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
					"muzzle_missile_1", "muzzle_missile_2", "muzzle_missile_3", "muzzle_missile_4", "muzzle_missile_5", "muzzle_missile_6", "muzzle_missile_7", "muzzle_missile_8", "muzzle_missile_9", "muzzle_missile_10",
                    "muzzle_missile_11", "muzzle_missile_12", "muzzle_missile_13", "muzzle_missile_14", "muzzle_missile_15", "muzzle_missile_16", "muzzle_missile_17", "muzzle_missile_18", "muzzle_missile_19", "muzzle_missile_20",
                    "muzzle_missile_21", "muzzle_missile_22", "muzzle_missile_23", "muzzle_missile_24", "muzzle_missile_25", "muzzle_missile_26", "muzzle_missile_27", "muzzle_missile_28", "muzzle_missile_29", "muzzle_missile_30",
                    "muzzle_missile_31", "muzzle_missile_32", "muzzle_missile_33", "muzzle_missile_34", "muzzle_missile_35", "muzzle_missile_36",
                },
            ...
            Targeting = new TargetingDef
            {
                ...
                MinimumDiameter = 5.0f, // Minimum radius of threat to engage.
                MaximumDiameter = 0.0f, // Maximum radius of threat to engage; 0 = unlimited.
                MaxTargetDistance = 3000.0f, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
                MinTargetDistance = 0f, // Minimum distance at which targets will be automatically shot at.
            ...
            {
                PartName = "LM036 L Sauvagine", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 5.0f, // Projectile inaccuracy in degrees.
                AimingTolerance = 180.0, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                ...
                {
                    RotateRate = 0.0125f, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                    ...
                    InventorySize = 0.43f, // Inventory capacity in kL.
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 990, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    ReloadSound = "OPC_Common_Reload", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
                ...
                Graphics = new HardPointParticleDef
                {
                    Effect1 = new ParticleDef
                    {
                        ...
                        Color = Color(red: 0.0f, green: 0.0f, blue: 0.0f, alpha: 0.0f), // Deprecated, set color in particle sbc.
                        Offset = Vector(x: 0.0, y: 0.0, z: 0.0), // Offsets the effect from the muzzle empty.
                        ApplyToShield = false,
                        Extras = new ParticleOptionDef
                        {
                            Loop = false, // Set this to the same as in the particle sbc!
                            Restart = false, // Whether to end a looping effect instantly when firing stops.
                            Scale = 0.0f, // Scale of effect.
                            MaxDistance = 10.0f,
                            MaxDuration = 0.0f,
                            HitPlayChance = 0.0f,
                        },
            ...
            Ammos = new[]
            {
                MSL_HEAT_011x12, // Must list all primary, shrapnel, and pattern ammos.
			},
