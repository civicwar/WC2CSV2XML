...
namespace WyN.WeaponCore
{
    partial class Parts
    {
        ...
        WeaponDefinition OPC_LM110_S => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = CreateSimilarMountPoints(
                    new MountPointDef
                    {
                        ...
                        MuzzlePartId = "LM110_S_Mount", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
            ...
            {
                PartName = "LM110 L Hauteclere", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.85f, // Inventory capacity in kL.
            ...
            Ammos = new[] {
                MSL_HEAT_102, MSL_DCOY_103, MSL_EMPW_101, // Must list all primary, shrapnel, and pattern ammos.
            },
