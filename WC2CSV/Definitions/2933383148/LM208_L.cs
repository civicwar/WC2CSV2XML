...
namespace WyN.WeaponCore
{
    partial class Parts
    {
        WeaponDefinition OPC_LM208_L => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "LM208_L", // Block Subtypeid. Your Cubeblocks contain this information
						SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
						MuzzlePartId = "LM208_Barrel", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                ...
                Muzzles = new[] { // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
					"muzzle_missile_1", "muzzle_missile_2", "muzzle_missile_3", "muzzle_missile_4", "muzzle_missile_5", "muzzle_missile_6", "muzzle_missile_7", "muzzle_missile_8",
                },
            ...
            Targeting = new TargetingDef
            {
                ...
                MaxTargetDistance = 10000.0f, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
                MinTargetDistance = 300.0f, // Minimum distance at which targets will be automatically shot at.
            ...
            {
                PartName = "LM208 L Durendal", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                                               //PartName = OPC_Localization.GetText("OPC_LM320L_PartName_WC_LID"),
                DeviateShotAngle = 5.0f, // Projectile inaccuracy in degrees.
                AimingTolerance = 90.0, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 3.2f, // Inventory capacity in kL.
            ...
            Ammos = new[]
            {
                MSL_HEAT_206, MSL_EMPW_207, // Must list all primary, shrapnel, and pattern ammos.
			},
