...
namespace WyN.WeaponCore
{
    partial class Parts
    {
        WeaponDefinition OPC_TER302_L => new WeaponDefinition
        {
            ...
            Targeting = new TargetingDef
            {
                ...
                MaxTargetDistance = 5300.0f, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
            ...
            {
                PartName = "TER302 L Moralltach", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    HeatSinkRate = 340, // Amount of heat lost per second.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "OPC_TER302_MFlash", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[]
            {
                TER302_Plasma, // Must list all primary, shrapnel, and pattern ammos.
			},
