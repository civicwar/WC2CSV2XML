...
namespace WyN.WeaponCore
{
    partial class Parts
    {
        ...
        WeaponDefinition OPC_LM112_L => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = CreateSimilarMountPoints(
                    new MountPointDef
                    {
                        ...
                        MuzzlePartId = "LM112_L_Gun", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "LM112_L_Tower", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "LM112_L_Gun",// Your Elevating Subpart, that bit that moves up.
                        /*/
                        ...
                        IconName = "Inventory\\LM110_Magazine_Slot.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
                    }
                    , "LM112_L"
                    , "LM112C_L"
                ),
                Muzzles = new[] {
                    "muzzle_missile_1", "muzzle_missile_2", "muzzle_missile_3", "muzzle_missile_4", "muzzle_missile_5", "muzzle_missile_6", "muzzle_missile_7", "muzzle_missile_8", "muzzle_missile_9", "muzzle_missile_10", "muzzle_missile_11", "muzzle_missile_12",
                },
            ...
            Targeting = new TargetingDef
            {
                ...
                MinimumDiameter = 3f, // Minimum radius of threat to engage.
                ...
                StopTrackingSpeed = 700, // Do not track threats traveling faster than this speed; 0 = unlimited.
            ...
            {
                PartName = "LM112 L Almace", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    ElevateRate = 0.0125f, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = -180,
                    MaxAzimuth = 180,
                    MinElevation = 0,
                    MaxElevation = 75,
            ...
            Ammos = new[] {
                MSL_HEAT_102, MSL_DCOY_103, MSL_EMPW_101
            },
