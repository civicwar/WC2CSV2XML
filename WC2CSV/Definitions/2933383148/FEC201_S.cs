...
namespace WyN.WeaponCore
{
    partial class Parts
    {
        WeaponDefinition OPC_FEC201_S => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = CreateSimilarMountPoints(
                    new MountPointDef
                    {
                        ...
                        MuzzlePartId = "FEC201_S_Gun",
                        AzimuthPartId = "FEC201_S_Gun", // this is fucking tower dummy, NOT base
                        ElevationPartId = "FEC201_S_Barrel",
            ...
            Targeting = new TargetingDef
            {
                ...
                MaxTargetDistance = 4000.0f, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
            ...
            {
                PartName = "FEC201 S Gae Assail", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    HeatPerShot = 1800, // Heat generated per shot.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "OPC_TEC201_MFlash", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[]
            {
                TEC201_Plasma, // Must list all primary, shrapnel, and pattern ammos.
			},
