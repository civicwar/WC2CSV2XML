...
namespace WyN.WeaponCore
{
    partial class Parts
    {
        WeaponDefinition OPC_TEC401_L => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = CreateSimilarMountPoints(
                    new MountPointDef
                    {
                        ...
                        /* add or remove second slash at begin to switch comment
						MuzzlePartId = "TEB101_L_Gun", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
						AzimuthPartId = "TEB101_L_Tower", // Your Rotating Subpart, the bit that moves sideways.
						ElevationPartId = "TEB101_L_Gun",// Your Elevating Subpart, that bit that moves up.
						*/
                        MuzzlePartId = "MissileTurretBarrels",
                        AzimuthPartId = "MissileTurretBase1", // this is fucking tower dummy, NOT base
            ...
            Targeting = new TargetingDef
            {
                ...
                MaxTargetDistance = 9000.0f, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
                MinTargetDistance = 50.0f, // Minimum distance at which targets will be automatically shot at.
            ...
            {
                PartName = "TEC401 L Claiomh Solais", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                                                      //PartName = OPC_Localization.GetText("OPC_TBC101L_PartName_WC_LID"),
                DeviateShotAngle = 0.05f, // Projectile inaccuracy in degrees.
                AimingTolerance = 3.0, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = (int)(5f * 60f), // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    MagsToLoad = 1, // Number of physical magazines to consume on reload.
                    DelayUntilFire = (int)(3f * 60f), // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    HeatPerShot = 50000, // Heat generated per shot.
                    MaxHeat = 160000, // Max heat before weapon enters cooldown (70% of max heat).
                    Cooldown = 0.75f, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
                    HeatSinkRate = 50000, // Amount of heat lost per second.
                    ...
                    DelayAfterBurst = 7, // How long to spend "reloading" after each burst. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                {
                    PreFiringSound = "OPC_TBC202_Pref", // Audio for warmup effect.
                    FiringSound = "OPC_TEC_Shot", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "OPC_Common_Reload", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "OPC_Common_NoAmmo",
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "OPC_TEC401_MFlash", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[]
            {
                TEC401_Plasma, // Must list all primary, shrapnel, and pattern ammos.
			},
