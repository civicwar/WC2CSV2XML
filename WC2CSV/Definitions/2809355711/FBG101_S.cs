 ...
 namespace WyN.WeaponCore
{
	partial class Parts
	{
		WeaponDefinition OPC_FBG101_S => new WeaponDefinition
		{
			Assignments = new ModelAssignmentsDef
			{
				MountPoints = CreateSimilarMountPoints(
					new MountPointDef {
						...
						MuzzlePartId = "FBG101_S_Gun", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
						AzimuthPartId = "FBG101_S_Gun", // Your Rotating Subpart, the bit that moves sideways.
						ElevationPartId = "FBG101_S_Barrel",// Your Elevating Subpart, that bit that moves up.
			...
			Targeting = new TargetingDef
			{
				...
				MaxTargetDistance = 0.0f, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
			...
			{
				PartName = "FBG101 S Nehte", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
				//PartName = OPC_Localization.GetText("OPC_FBG101S_PartName_WC_LID"),
