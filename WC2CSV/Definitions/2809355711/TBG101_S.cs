 ...
 namespace WyN.WeaponCore
{
	partial class Parts
	{
		WeaponDefinition OPC_TBG101_S => new WeaponDefinition
		{
			Assignments = new ModelAssignmentsDef
			{
				MountPoints = CreateSimilarMountPoints(
					new MountPointDef {
						...
						MuzzlePartId = "TBG101_S_Gun", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
						AzimuthPartId = "TBG101_S_Tower", // Your Rotating Subpart, the bit that moves sideways.
						ElevationPartId = "TBG101_S_Gun",// Your Elevating Subpart, that bit that moves up.
						/*/
						...
						IconName = "Inventory\\BMG_Magazine_Slot.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
					}
					,"TBG101_S"
					,"TBG101_S_inv"
					,"TBG101C_S"
				...
				Scope = "LOS", // Where line of sight checks are performed from. Must be clear of block collision.
			},
			
			Targeting = new TargetingDef
			{
				Threats = new[] {
					Grids, Characters, Meteors, Neutrals, Projectiles // Types of threat to engage: Grids, Projectiles, Characters, Meteors, Neutrals
				},
				SubSystems = new[] {
				...
				MaxTargetDistance = 900.0f, //800.0f, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
			...
			{
				PartName = "TBG101 S Hatal", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
				//PartName = OPC_Localization.GetText("OPC_TBG101S_PartName_WC_LID"),
				DeviateShotAngle = 0.2f, // Projectile inaccuracy in degrees.
				AimingTolerance = 0.0, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
				...
				HardWare = new HardwareDef
				{
					...
					InventorySize = 0.025f * 4f / 3f, // Inventory capacity in kL.
				...
				{
					RateOfFire = 720, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
					...
					HeatPerShot = 1435, // Heat generated per shot.
				...
				Audio = new HardPointAudioDef
				{
					...
					FiringSound = "OPC_TBG_Shot", // Audio for firing.
					...
					HardPointRotationSound = "OPC_Common_Rotate_Lht", // Audio played when turret is moving.
					BarrelRotationSound = "",
			...
			Ammos = new[]
			{
				TBG101_50_BMG, // Must list all primary, shrapnel, and pattern ammos.
			},
