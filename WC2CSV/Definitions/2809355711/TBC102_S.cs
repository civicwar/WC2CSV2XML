 ...
 namespace WyN.WeaponCore
{
	partial class Parts
	{
		WeaponDefinition OPC_TBC102_S => new WeaponDefinition
		{
			Assignments = new ModelAssignmentsDef
			{
				MountPoints = CreateSimilarMountPoints(
					new MountPointDef {
						...
						MuzzlePartId = "TBC101_L_Barrel", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
						AzimuthPartId = "TBC101_L_Tower", // Your Rotating Subpart, the bit that moves sideways.
						ElevationPartId = "TBC101_L_Barrel",// Your Elevating Subpart, that bit that moves up.
						/*/
						...
						IconName = "Inventory\\FBC101_Magazine_Slot.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
					}
					,"TBC102_S"
					,"TBC102C_S"
				),
			...
			Targeting = new TargetingDef
			{
				...
				MaxTargetDistance = 2800.0f, //1800.0f, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
			...
			{
				PartName = "TBC102 S Samosek", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
				...
				HardWare = new HardwareDef
				{
					...
					InventorySize = 0.1f * 0.81f / 3f, // Inventory capacity in kL.
				...
				Loading = new LoadingDef
				{
					...
					HeatPerShot = 350, // Heat generated per shot.
					MaxHeat = 4200, // Max heat before weapon enters cooldown (70% of max heat).
					Cooldown = 0.10f, // Percentage of max heat to be under to start firing again after overheat; accepts 0 - 0.95
					HeatSinkRate = 2600, // Amount of heat lost per second.
				...
				Audio = new HardPointAudioDef
				{
					...
					FiringSound = "OPC_FBC_Shot", // Audio for firing.
				...
				Graphics = new HardPointParticleDef
				{
					...
					{
						Name = "OPC_FBC101_MFlash", // SubtypeId of muzzle particle effect.
			...
			{
				FBC101_Round_APFSDS,
				FBC101_Round_HESH, // Must list all primary, shrapnel, and pattern ammos.
			},
