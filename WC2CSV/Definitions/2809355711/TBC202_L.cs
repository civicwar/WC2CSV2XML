 ...
 namespace WyN.WeaponCore
{
	partial class Parts
	{
		WeaponDefinition OPC_TBC202_L => new WeaponDefinition
		{
			Assignments = new ModelAssignmentsDef
			{
				MountPoints = CreateSimilarMountPoints(
					new MountPointDef {
						...
						MuzzlePartId = "TBC202_L_Barrel", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
						AzimuthPartId = "TBC202_L_Tower", // Your Rotating Subpart, the bit that moves sideways.
						ElevationPartId = "TBC202_L_Barrel",// Your Elevating Subpart, that bit that moves up.
						/*/
						...
						IconName = "Inventory\\TBC202_Magazine_Slot.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
					}
					,"TBC202_L"
					,"TBC202C_L"
				),
			...
			Targeting = new TargetingDef
			{
				...
				MaxTargetDistance = 9000.0f, //2500.0f, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
				MinTargetDistance = 100.0f, // Minimum distance at which targets will be automatically shot at.
			...
			{
				PartName = "TBC202 L Excalibur", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
				//PartName = OPC_Localization.GetText("OPC_TBC202L_PartName_WC_LID"),
				DeviateShotAngle = 0.01f, // Projectile inaccuracy in degrees.
				AimingTolerance = 2.5, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
				...
				HardWare = new HardwareDef
				{
					...
					InventorySize = 0.3f,
					// 0.5 is volume of one ammo, to be able to pull ammo via conveyor system, atleast 1/3 from items per tick volume must be free
					// inventory of this weapon should be able to hold two ammo mag items so we need to multiply one item with 2.6~
					// here 8 is 2(items amount) * (3(divider) + 1); divide 8 on 3 will return 2.6~
				...
				{
					RateOfFire = 75, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
					...
					HeatPerShot = 700, // Heat generated per shot.
				...
				Audio = new HardPointAudioDef
				{
					...
					FiringSound = "OPC_TBC_Shot", // Audio for firing.
				...
				Graphics = new HardPointParticleDef
				{
					...
					{
						Name = "OPC_TBC202_MFlash", // SubtypeId of muzzle particle effect.
			...
			{
				TBC202_Blank,
				TBC202_Blank_Elite, // Must list all primary, shrapnel, and pattern ammos.
			},
			
			//Animations = TBC202_L_Animation,
