 ...
 namespace WyN.WeaponCore
{
	partial class Parts
	{
		WeaponDefinition OPC_TBR101_S => new WeaponDefinition
		{
			Assignments = new ModelAssignmentsDef
			{
				MountPoints = CreateSimilarMountPoints(
					new MountPointDef {
						...
						MuzzlePartId = "TBR101_S_Gun", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
						AzimuthPartId = "TBR101_S_Tower", // Your Rotating Subpart, the bit that moves sideways.
						ElevationPartId = "TBR101_S_Gun",// Your Elevating Subpart, that bit that moves up.
						/*/
			...
			Targeting = new TargetingDef
			{
				...
				MaxTargetDistance = 1900f, //1450.0f, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
			...
			{
				PartName = "TBR102 S Mjolnir", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
				//PartName = OPC_Localization.GetText("OPC_TBR101S_PartName_WC_LID"),
				DeviateShotAngle = 0.07f, // Projectile inaccuracy in degrees.
				AimingTolerance = 0.25, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
