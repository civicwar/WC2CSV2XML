...
namespace WyN.WeaponCore
{
    partial class Parts
    {
        WeaponDefinition OPC_FBR101_S => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = CreateSimilarMountPoints(
                    new MountPointDef
                    {
                        ...
                        MuzzlePartId = "FBR101_S_Gun", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "FBR101_S_Gun", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "FBR101_S_Barrel",// Your Elevating Subpart, that bit that moves up.
            ...
            {
                PartName = "FBR101 S Gleipnir", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                                                //PartName = OPC_Localization.GetText("OPC_FBR101S_PartName_WC_LID"),
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.05f, // Inventory capacity in kL.
                ...
                Loading = new LoadingDef
                {
                    ...
                    HeatPerShot = 3850, // Heat generated per shot.
            ...
            Ammos = new[]
            {
                TBR102_APBC_T, TBR102_HE_T // Must list all primary, shrapnel, and pattern ammos.
			},
