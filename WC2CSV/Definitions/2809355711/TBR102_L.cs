...
namespace WyN.WeaponCore
{
    partial class Parts
    {
        WeaponDefinition OPC_TBR102_L => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = CreateSimilarMountPoints(
                    new MountPointDef
                    {
						...
						MuzzlePartId = "TBR102_L_Gun", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
						AzimuthPartId = "TBR102_L_Tower", // Your Rotating Subpart, the bit that moves sideways.
						ElevationPartId = "TBR102_L_Gun",// Your Elevating Subpart, that bit that moves up.
						/*/
                        ...
                        IconName = "Inventory\\APBC_T_Magazine_Slot.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
                    }
                    , "TBR102_L"
                    , "TBR102C_L"
                ),
            ...
            {
                Threats = new[] {
                    Grids, Projectiles, Characters, Meteors, Neutrals // Types of threat to engage: Grids, Projectiles, Characters, Meteors, Neutrals
				},
                SubSystems = new[] {
                ...
                MaxTargetDistance = 1900.0f, //1450.0f, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
            ...
            {
                PartName = "TBR102 L Gungnir", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                                               //PartName = OPC_Localization.GetText("OPC_TBR102L_PartName_WC_LID"),
                DeviateShotAngle = 0.07f, // Projectile inaccuracy in degrees.
                AimingTolerance = 0.3, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.085f, // Inventory capacity in kL.
                ...
                Loading = new LoadingDef
                {
                    ...
                    HeatPerShot = 7350, // Heat generated per shot.
                    ...
                    HeatSinkRate = 70000, // Amount of heat lost per second.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "OPC_TBR_Shot", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "OPC_TBR10X_MFlash", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[]
            {
                TBR102_APBC_T, TBR102_HE_T //TBR102_HE_T Must list all primary, shrapnel, and pattern ammos.
			},
