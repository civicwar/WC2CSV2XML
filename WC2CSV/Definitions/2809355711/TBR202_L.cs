...
namespace WyN.WeaponCore
{
    partial class Parts
    {
        WeaponDefinition OPC_TBR202_L => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = CreateSimilarMountPoints(
                    new MountPointDef
                    {
                        ...
                        IconName = "Inventory\\TBR202_Magazine_Slot.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
                    }
                    , "TBR202_L"
                    , "TBR202C_L"
                ),
            ...
            Targeting = new TargetingDef
            {
                ...
                MaxTargetDistance = 5000.0f, //2500.0f, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
                MinTargetDistance = 10.0f, // Minimum distance at which targets will be automatically shot at.
            ...
            {
                PartName = "TBR202 L Skofnung", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    HeatPerShot = 400, // Heat generated per shot.
                    MaxHeat = 9000, // Max heat before weapon enters cooldown (70% of max heat).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "OPC_TBR202_Shot", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "OPC_TBR202_MFlash", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[]
            {
                TBR202_Round_Default, // Must list all primary, shrapnel, and pattern ammos.
			},
