...
using static CoreSystems.Support.WeaponDefinition.TargetingDef.CommunicationDef.Comms;
using static CoreSystems.Support.WeaponDefinition.TargetingDef.CommunicationDef.SecurityMode;
...
using static CoreSystems.Support.WeaponDefinition.HardPointDef.HardwareDef.HardwareType;
 ...
 namespace WyN.WeaponCore {   
    partial class Parts {
        ...
        WeaponDefinition OPC_TR100_L => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
			{
				MountPoints = CreateSimilarMountPoints(
					new MountPointDef {
						...
						MuzzlePartId = "TR100_L_Gun", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
						AzimuthPartId = "TR100_L_Tower", // Your Rotating Subpart, the bit that moves sideways.
						ElevationPartId = "TR100_L_Gun",// Your Elevating Subpart, that bit that moves up.
						DurabilityMod = 0.25f, // GeneralDamageMultiplier, 0.25f = 25% damage taken.
						//IconName = "Weapons\\TR100_L.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
					}
					,"TR100_L"
					,"TR100C_L"
					,"TR100_S"
            ...
            Targeting = new TargetingDef
            {
                Threats = new[] {
                    ScanEnemyGrid,
					Grids,
					ScanEnemyCharacter, // Types of threat to engage: Grids, Projectiles, Characters, Meteors, Neutrals, ScanRoid, ScanPlanet, ScanFriendlyCharacter, ScanFriendlyGrid, ScanEnemyCharacter, ScanEnemyGrid, ScanNeutralCharacter, ScanNeutralGrid, ScanUnOwnedGrid, ScanOwnersGrid
                },
                SubSystems = new[] {
                ...
                MaxTargetDistance = 17000, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
                ...
                Communications = new CommunicationDef 
                {
                    ...
                    Security = Secure, // Public, Private, Secure
                    BroadCastChannel = "", // If defined you will broadcast to all other scanners on this channel.
                    BroadCastRange = 16000, // This is the range that you will broadcast up too.  Note that this value applies to both the sender and receiver, both range requirements must be met. 
                    ...
                    RelayChannel = "1", // If defined this channel will be used to relay any targets it seems on the broadcast channel.
                    RelayRange = 16000, // This defines the range that any broadcasts will be relayed.  Note that this channel id is seen as the "broadcast" channel for all receivers, broadcast range requirements apply. 
                },
            },
            HardPoint = new HardPointDef
            {
                PartName = "TR100 Oko", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                TR100_Energy,  // Must list all primary, shrapnel, and pattern ammos.
            },
