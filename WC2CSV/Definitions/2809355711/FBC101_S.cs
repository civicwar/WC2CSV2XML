...
namespace WyN.WeaponCore
{
    partial class Parts
    {
        WeaponDefinition OPC_FBC101_S => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = CreateSimilarMountPoints(
                    new MountPointDef
                    {
                        ...
                        MuzzlePartId = "FBC101_S_Gun", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "FBC101_S_Gun", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "FBC101_S_Barrel",// Your Elevating Subpart, that bit that moves up.
            ...
            {
                PartName = "FBC101 S Kladenets", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                                                 //PartName = OPC_Localization.GetText("OPC_FBC101S_PartName_WC_LID"),
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.012f * 4f / 3f, // Inventory capacity in kL.
            ...
            Ammos = new[]
            {
                FBC101_Round_APFSDS, FBC101_Round_HESH // Must list all primary, shrapnel, and pattern ammos.
			},
