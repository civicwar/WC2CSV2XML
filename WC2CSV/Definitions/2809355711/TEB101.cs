 ...
 namespace WyN.WeaponCore
{
	partial class Parts
	{
		WeaponDefinition OPC_TEB101 => new WeaponDefinition
		{
			Assignments = new ModelAssignmentsDef
			{
				MountPoints = CreateSimilarMountPoints(
					new MountPointDef {
						...
						//IconName = "Weapons\\TEB101.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
					}
					,"TEB101_L"
					,"TEB101_S"
					,"TEB101C_L"
			...
			{
				Threats = new[] {
					Projectiles, Meteors, Characters // Types of threat to engage: Grids, Projectiles, Characters, Meteors, Neutrals, Other
				},
				SubSystems = new[] {
				...
				MinimumDiameter = 0.1f, // Minimum radius of threat to engage.
				MaximumDiameter = 0.0f, // Maximum radius of threat to engage; 0 = unlimited.
				MaxTargetDistance = 1400.0f, //800.0f, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
				MinTargetDistance = 1.0f, // Minimum distance at which targets will be automatically shot at.
			...
			{
				PartName = "TEB101 Ancile", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
				//PartName = OPC_Localization.GetText("OPC_TEB101C_PartName_WC_LID"),
				DeviateShotAngle = 0.01f, // Projectile inaccuracy in degrees.
				AimingTolerance = 5.0, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
				...
				HardWare = new HardwareDef
				{
					...
					InventorySize = 0.0f, // Inventory capacity in kL.
				...
				Audio = new HardPointAudioDef
				{
					...
					FiringSound = "OPC_TEB_Shot", // Audio for firing.
			...
			Ammos = new[]
			{
				TEB101_Energy, // Must list all primary, shrapnel, and pattern ammos.
			},
