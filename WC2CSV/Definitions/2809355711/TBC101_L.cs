 ...
 namespace WyN.WeaponCore
{
	partial class Parts
	{
		WeaponDefinition OPC_TBC101_L => new WeaponDefinition
		{
			Assignments = new ModelAssignmentsDef
			{
				MountPoints = CreateSimilarMountPoints(
					new MountPointDef {
						...
						IconName = "Inventory\\TBC101_Magazine_Slot.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
					}
					,"TBC101_L"
					,"TBC101C_L"
					,"TBC101_S"
			...
			Targeting = new TargetingDef
			{
				...
				MaxTargetDistance = 7000.0f, //1800.0f, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
			...
			{
				PartName = "TBC101 Thunderbolt", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
				...
				HardWare = new HardwareDef
				{
					...
					InventorySize = 0.075f, // Inventory capacity in kL.
				...
				{
					PreFiringSound = "OPC_TBC101_Pref", // Audio for warmup effect.
				...
				Graphics = new HardPointParticleDef
				{
					...
					{
						Name = "OPC_TBC101_MFlash", // SubtypeId of muzzle particle effect.
			...
			{
				TBC101_Blank,
				TBC101_Blank_Elite, // Must list all primary, shrapnel, and pattern ammos.
			},
			
			//Animations = TBC101_L_Animation,
