...
namespace WyN.WeaponCore
{
    partial class Parts
    {
        WeaponDefinition OPC_TBC404_L => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = CreateSimilarMountPoints(
                    new MountPointDef
                    {
                        ...
                        IconName = "Inventory\\TBC404_Magazine_Slot.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
                    }
                    , "TBC404_L",
                    "TBC404C_L"
            ...
            Targeting = new TargetingDef
            {
                ...
                MinTargetDistance = 200.0f, // Minimum distance at which targets will be automatically shot at.
            ...
            {
                PartName = "TBC404 L Hofund", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    HeatPerShot = 1300, // Heat generated per shot.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "OPC_TBC404_Shot", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "OPC_TBC404_MFlash", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[]
            {
                TBC404_Round_Default,// Must list all primary, shrapnel, and pattern ammos.
			},
